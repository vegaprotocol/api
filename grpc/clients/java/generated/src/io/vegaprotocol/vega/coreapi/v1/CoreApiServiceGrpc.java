...
public final class CoreApiServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<io.vegaprotocol.vega.coreapi.v1.Coreapi.ListMarketsDataRequest,
      io.vegaprotocol.vega.coreapi.v1.Coreapi.ListMarketsDataResponse> getListMarketsDataMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "ListMarketsData",
      requestType = io.vegaprotocol.vega.coreapi.v1.Coreapi.ListMarketsDataRequest.class,
      responseType = io.vegaprotocol.vega.coreapi.v1.Coreapi.ListMarketsDataResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<io.vegaprotocol.vega.coreapi.v1.Coreapi.ListMarketsDataRequest,
      io.vegaprotocol.vega.coreapi.v1.Coreapi.ListMarketsDataResponse> getListMarketsDataMethod() {
    io.grpc.MethodDescriptor<io.vegaprotocol.vega.coreapi.v1.Coreapi.ListMarketsDataRequest, io.vegaprotocol.vega.coreapi.v1.Coreapi.ListMarketsDataResponse> getListMarketsDataMethod;
    if ((getListMarketsDataMethod = CoreApiServiceGrpc.getListMarketsDataMethod) == null) {
      synchronized (CoreApiServiceGrpc.class) {
        if ((getListMarketsDataMethod = CoreApiServiceGrpc.getListMarketsDataMethod) == null) {
          CoreApiServiceGrpc.getListMarketsDataMethod = getListMarketsDataMethod =
              io.grpc.MethodDescriptor.<io.vegaprotocol.vega.coreapi.v1.Coreapi.ListMarketsDataRequest, io.vegaprotocol.vega.coreapi.v1.Coreapi.ListMarketsDataResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "ListMarketsData"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  io.vegaprotocol.vega.coreapi.v1.Coreapi.ListMarketsDataRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  io.vegaprotocol.vega.coreapi.v1.Coreapi.ListMarketsDataResponse.getDefaultInstance()))
              .setSchemaDescriptor(new CoreApiServiceMethodDescriptorSupplier("ListMarketsData"))
              .build();
        }
      }
    }
    return getListMarketsDataMethod;
  }

  private static volatile io.grpc.MethodDescriptor<io.vegaprotocol.vega.coreapi.v1.Coreapi.ListVotesRequest,
      io.vegaprotocol.vega.coreapi.v1.Coreapi.ListVotesResponse> getListVotesMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "ListVotes",
      requestType = io.vegaprotocol.vega.coreapi.v1.Coreapi.ListVotesRequest.class,
      responseType = io.vegaprotocol.vega.coreapi.v1.Coreapi.ListVotesResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<io.vegaprotocol.vega.coreapi.v1.Coreapi.ListVotesRequest,
      io.vegaprotocol.vega.coreapi.v1.Coreapi.ListVotesResponse> getListVotesMethod() {
    io.grpc.MethodDescriptor<io.vegaprotocol.vega.coreapi.v1.Coreapi.ListVotesRequest, io.vegaprotocol.vega.coreapi.v1.Coreapi.ListVotesResponse> getListVotesMethod;
    if ((getListVotesMethod = CoreApiServiceGrpc.getListVotesMethod) == null) {
      synchronized (CoreApiServiceGrpc.class) {
        if ((getListVotesMethod = CoreApiServiceGrpc.getListVotesMethod) == null) {
          CoreApiServiceGrpc.getListVotesMethod = getListVotesMethod =
              io.grpc.MethodDescriptor.<io.vegaprotocol.vega.coreapi.v1.Coreapi.ListVotesRequest, io.vegaprotocol.vega.coreapi.v1.Coreapi.ListVotesResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "ListVotes"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  io.vegaprotocol.vega.coreapi.v1.Coreapi.ListVotesRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  io.vegaprotocol.vega.coreapi.v1.Coreapi.ListVotesResponse.getDefaultInstance()))
              .setSchemaDescriptor(new CoreApiServiceMethodDescriptorSupplier("ListVotes"))
              .build();
        }
      }
    }
  ...
  public static abstract class CoreApiServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void listMarketsData(io.vegaprotocol.vega.coreapi.v1.Coreapi.ListMarketsDataRequest request,
        io.grpc.stub.StreamObserver<io.vegaprotocol.vega.coreapi.v1.Coreapi.ListMarketsDataResponse> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getListMarketsDataMethod(), responseObserver);
    }

    /**
     */
    public void listVotes(io.vegaprotocol.vega.coreapi.v1.Coreapi.ListVotesRequest request,
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          ...
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                io.vegaprotocol.vega.coreapi.v1.Coreapi.ListMarketsDataRequest,
                io.vegaprotocol.vega.coreapi.v1.Coreapi.ListMarketsDataResponse>(
                  this, METHODID_LIST_MARKETS_DATA)))
          .addMethod(
            getListVotesMethod(),
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
  ...
  public static final class CoreApiServiceStub extends io.grpc.stub.AbstractAsyncStub<CoreApiServiceStub> {
    ...
    public void listMarketsData(io.vegaprotocol.vega.coreapi.v1.Coreapi.ListMarketsDataRequest request,
        io.grpc.stub.StreamObserver<io.vegaprotocol.vega.coreapi.v1.Coreapi.ListMarketsDataResponse> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
          getChannel().newCall(getListMarketsDataMethod(), getCallOptions()), request, responseObserver);
    }
  ...
  public static final class CoreApiServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<CoreApiServiceBlockingStub> {
    ...
    /**
     */
    public io.vegaprotocol.vega.coreapi.v1.Coreapi.ListMarketsDataResponse listMarketsData(io.vegaprotocol.vega.coreapi.v1.Coreapi.ListMarketsDataRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
          getChannel(), getListMarketsDataMethod(), getCallOptions(), request);
    }
  ...
  public static final class CoreApiServiceFutureStub extends io.grpc.stub.AbstractFutureStub<CoreApiServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<io.vegaprotocol.vega.coreapi.v1.Coreapi.ListMarketsDataResponse> listMarketsData(
        io.vegaprotocol.vega.coreapi.v1.Coreapi.ListMarketsDataRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
          getChannel().newCall(getListMarketsDataMethod(), getCallOptions()), request);
    }

    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<io.vegaprotocol.vega.coreapi.v1.Coreapi.ListVotesResponse> listVotes(
        io.vegaprotocol.vega.coreapi.v1.Coreapi.ListVotesRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
      ...
      switch (methodId) {
        ...
        case METHODID_LIST_PROPOSALS:
          serviceImpl.listProposals((io.vegaprotocol.vega.coreapi.v1.Coreapi.ListProposalsRequest) request,
              (io.grpc.stub.StreamObserver<io.vegaprotocol.vega.coreapi.v1.Coreapi.ListProposalsResponse>) responseObserver);
          break;
        case METHODID_LIST_MARKETS_DATA:
          serviceImpl.listMarketsData((io.vegaprotocol.vega.coreapi.v1.Coreapi.ListMarketsDataRequest) request,
              (io.grpc.stub.StreamObserver<io.vegaprotocol.vega.coreapi.v1.Coreapi.ListMarketsDataResponse>) responseObserver);
          break;
