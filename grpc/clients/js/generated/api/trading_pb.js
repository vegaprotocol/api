...
proto.api.v1.PrepareVoteSubmissionRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    submission: (f = msg.getSubmission()) && governance_pb.VoteSubmission.toObject(includeInstance, f)
  };
...
/**
 * optional vega.VoteSubmission submission = 1;
...
proto.api.v1.PrepareVoteSubmissionRequest.prototype.getSubmission = function() {
  return /** @type{?proto.vega.VoteSubmission} */ (
    jspb.Message.getWrapperField(this, governance_pb.VoteSubmission, 1));
};
...
/**
 * optional vega.VoteSubmission submission = 2;
 * @return {?proto.vega.VoteSubmission}
 */
proto.api.v1.PrepareVoteSubmissionResponse.prototype.getSubmission = function() {
  return /** @type{?proto.vega.VoteSubmission} */ (
    jspb.Message.getWrapperField(this, governance_pb.VoteSubmission, 2));
};
