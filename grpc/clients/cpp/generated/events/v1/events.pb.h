...
template<> ::vega::events::v1::ValidatorScoreEvent* Arena::CreateMaybeMessage<::vega::events::v1::ValidatorScoreEvent>(Arena*);
...
class ValidatorScoreEvent PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:vega.events.v1.ValidatorScoreEvent) */ {
 public:
  inline ValidatorScoreEvent() : ValidatorScoreEvent(nullptr) {}
  virtual ~ValidatorScoreEvent();

  ValidatorScoreEvent(const ValidatorScoreEvent& from);
  ValidatorScoreEvent(ValidatorScoreEvent&& from) noexcept
    : ValidatorScoreEvent() {
    *this = ::std::move(from);
  }

  inline ValidatorScoreEvent& operator=(const ValidatorScoreEvent& from) {
    CopyFrom(from);
    return *this;
  }
  inline ValidatorScoreEvent& operator=(ValidatorScoreEvent&& from) noexcept {
    if (GetArena() == from.GetArena()) {
      if (this != &from) InternalSwap(&from);
    } else {
      CopyFrom(from);
  ...
  static const ValidatorScoreEvent& default_instance();

  static inline const ValidatorScoreEvent* internal_default_instance() {
    return reinterpret_cast<const ValidatorScoreEvent*>(
               &_ValidatorScoreEvent_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    3;

  friend void swap(ValidatorScoreEvent& a, ValidatorScoreEvent& b) {
    a.Swap(&b);
  }
  inline void Swap(ValidatorScoreEvent* other) {
    if (other == this) return;
    if (GetArena() == other->GetArena()) {
      InternalSwap(other);
    } else {
  ...
  void UnsafeArenaSwap(ValidatorScoreEvent* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetArena() == other->GetArena());
    InternalSwap(other);
  }
  ...
  inline ValidatorScoreEvent* New() const final {
    return CreateMaybeMessage<ValidatorScoreEvent>(nullptr);
  }

  ValidatorScoreEvent* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<ValidatorScoreEvent>(arena);
  }
  void CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void CopyFrom(const ValidatorScoreEvent& from);
  void MergeFrom(const ValidatorScoreEvent& from);
  PROTOBUF_ATTRIBUTE_REINITIALIZES void Clear() final;
  bool IsInitialized() const final;
  ...
  inline void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(ValidatorScoreEvent* other);
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "vega.events.v1.ValidatorScoreEvent";
  }
  protected:
  explicit ValidatorScoreEvent(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  private:
  static void ArenaDtor(void* object);
  inline void RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  public:
  ...
  enum : int {
    ...
    kEpochSeqFieldNumber = 2,
    kValidatorScoreFieldNumber = 3,
    kNormalisedScoreFieldNumber = 4,
  };
  ...
  void clear_validator_score();
  const std::string& validator_score() const;
  void set_validator_score(const std::string& value);
  void set_validator_score(std::string&& value);
  void set_validator_score(const char* value);
  void set_validator_score(const char* value, size_t size);
  std::string* mutable_validator_score();
  std::string* release_validator_score();
  void set_allocated_validator_score(std::string* validator_score);
  private:
  const std::string& _internal_validator_score() const;
  void _internal_set_validator_score(const std::string& value);
  std::string* _internal_mutable_validator_score();
  public:
 ...
 private:
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr epoch_seq_;
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr validator_score_;
...
class BusEvent PROTOBUF_FINAL :
 ...
 public:
  ...
  enum : int {
    ...
    kValidatorScoreFieldNumber = 130,
  ...
  bool has_validator_score() const;
  private:
  bool _internal_has_validator_score() const;
  public:
  void clear_validator_score();
  const ::vega::events::v1::ValidatorScoreEvent& validator_score() const;
  ::vega::events::v1::ValidatorScoreEvent* release_validator_score();
  ::vega::events::v1::ValidatorScoreEvent* mutable_validator_score();
  void set_allocated_validator_score(::vega::events::v1::ValidatorScoreEvent* validator_score);
  private:
  const ::vega::events::v1::ValidatorScoreEvent& _internal_validator_score() const;
  ::vega::events::v1::ValidatorScoreEvent* _internal_mutable_validator_score();
  public:
  void unsafe_arena_set_allocated_validator_score(
      ::vega::events::v1::ValidatorScoreEvent* validator_score);
  ::vega::events::v1::ValidatorScoreEvent* unsafe_arena_release_validator_score();
 ...
 private:
  ...
  union EventUnion {
    ...
    ::vega::events::v1::ValidatorScoreEvent* validator_score_;
...
// string node_id = 1 [json_name = "nodeId"];
inline void ValidatorScoreEvent::clear_node_id() {
  node_id_.ClearToEmpty();
}
inline const std::string& ValidatorScoreEvent::node_id() const {
  // @@protoc_insertion_point(field_get:vega.events.v1.ValidatorScoreEvent.node_id)
  return _internal_node_id();
}
inline void ValidatorScoreEvent::set_node_id(const std::string& value) {
  _internal_set_node_id(value);
  // @@protoc_insertion_point(field_set:vega.events.v1.ValidatorScoreEvent.node_id)
}
inline std::string* ValidatorScoreEvent::mutable_node_id() {
  // @@protoc_insertion_point(field_mutable:vega.events.v1.ValidatorScoreEvent.node_id)
  return _internal_mutable_node_id();
}
inline const std::string& ValidatorScoreEvent::_internal_node_id() const {
  return node_id_.Get();
}
inline void ValidatorScoreEvent::_internal_set_node_id(const std::string& value) {

  node_id_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArena());
}
inline void ValidatorScoreEvent::set_node_id(std::string&& value) {

  node_id_.Set(
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::move(value), GetArena());
  // @@protoc_insertion_point(field_set_rvalue:vega.events.v1.ValidatorScoreEvent.node_id)
}
inline void ValidatorScoreEvent::set_node_id(const char* value) {
  GOOGLE_DCHECK(value != nullptr);

  node_id_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(value), GetArena());
  // @@protoc_insertion_point(field_set_char:vega.events.v1.ValidatorScoreEvent.node_id)
}
inline void ValidatorScoreEvent::set_node_id(const char* value,
    size_t size) {
  ...
  node_id_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
  // @@protoc_insertion_point(field_set_pointer:vega.events.v1.ValidatorScoreEvent.node_id)
}
inline std::string* ValidatorScoreEvent::_internal_mutable_node_id() {

  return node_id_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArena());
}
inline std::string* ValidatorScoreEvent::release_node_id() {
  // @@protoc_insertion_point(field_release:vega.events.v1.ValidatorScoreEvent.node_id)
  return node_id_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline void ValidatorScoreEvent::set_allocated_node_id(std::string* node_id) {
  if (node_id != nullptr) {
  ...
  node_id_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), node_id,
      GetArena());
  // @@protoc_insertion_point(field_set_allocated:vega.events.v1.ValidatorScoreEvent.node_id)
}

// string epoch_seq = 2 [json_name = "epochSeq"];
inline void ValidatorScoreEvent::clear_epoch_seq() {
  epoch_seq_.ClearToEmpty();
}
inline const std::string& ValidatorScoreEvent::epoch_seq() const {
  // @@protoc_insertion_point(field_get:vega.events.v1.ValidatorScoreEvent.epoch_seq)
  return _internal_epoch_seq();
}
inline void ValidatorScoreEvent::set_epoch_seq(const std::string& value) {
  _internal_set_epoch_seq(value);
  // @@protoc_insertion_point(field_set:vega.events.v1.ValidatorScoreEvent.epoch_seq)
}
inline std::string* ValidatorScoreEvent::mutable_epoch_seq() {
  // @@protoc_insertion_point(field_mutable:vega.events.v1.ValidatorScoreEvent.epoch_seq)
  return _internal_mutable_epoch_seq();
}
inline const std::string& ValidatorScoreEvent::_internal_epoch_seq() const {
  return epoch_seq_.Get();
}
inline void ValidatorScoreEvent::_internal_set_epoch_seq(const std::string& value) {

  epoch_seq_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArena());
}
inline void ValidatorScoreEvent::set_epoch_seq(std::string&& value) {

  epoch_seq_.Set(
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::move(value), GetArena());
  // @@protoc_insertion_point(field_set_rvalue:vega.events.v1.ValidatorScoreEvent.epoch_seq)
}
inline void ValidatorScoreEvent::set_epoch_seq(const char* value) {
  GOOGLE_DCHECK(value != nullptr);

  epoch_seq_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(value), GetArena());
  // @@protoc_insertion_point(field_set_char:vega.events.v1.ValidatorScoreEvent.epoch_seq)
}
inline void ValidatorScoreEvent::set_epoch_seq(const char* value,
    size_t size) {
  ...
  epoch_seq_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
  // @@protoc_insertion_point(field_set_pointer:vega.events.v1.ValidatorScoreEvent.epoch_seq)
}
inline std::string* ValidatorScoreEvent::_internal_mutable_epoch_seq() {

  return epoch_seq_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArena());
}
inline std::string* ValidatorScoreEvent::release_epoch_seq() {
  // @@protoc_insertion_point(field_release:vega.events.v1.ValidatorScoreEvent.epoch_seq)
  return epoch_seq_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline void ValidatorScoreEvent::set_allocated_epoch_seq(std::string* epoch_seq) {
  if (epoch_seq != nullptr) {
  ...
  epoch_seq_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), epoch_seq,
      GetArena());
  // @@protoc_insertion_point(field_set_allocated:vega.events.v1.ValidatorScoreEvent.epoch_seq)
}

// string validator_score = 3 [json_name = "validatorScore"];
inline void ValidatorScoreEvent::clear_validator_score() {
  validator_score_.ClearToEmpty();
}
inline const std::string& ValidatorScoreEvent::validator_score() const {
  // @@protoc_insertion_point(field_get:vega.events.v1.ValidatorScoreEvent.validator_score)
  return _internal_validator_score();
}
inline void ValidatorScoreEvent::set_validator_score(const std::string& value) {
  _internal_set_validator_score(value);
  // @@protoc_insertion_point(field_set:vega.events.v1.ValidatorScoreEvent.validator_score)
}
inline std::string* ValidatorScoreEvent::mutable_validator_score() {
  // @@protoc_insertion_point(field_mutable:vega.events.v1.ValidatorScoreEvent.validator_score)
  return _internal_mutable_validator_score();
}
inline const std::string& ValidatorScoreEvent::_internal_validator_score() const {
  return validator_score_.Get();
}
inline void ValidatorScoreEvent::_internal_set_validator_score(const std::string& value) {

  validator_score_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArena());
}
inline void ValidatorScoreEvent::set_validator_score(std::string&& value) {

  validator_score_.Set(
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::move(value), GetArena());
  // @@protoc_insertion_point(field_set_rvalue:vega.events.v1.ValidatorScoreEvent.validator_score)
}
inline void ValidatorScoreEvent::set_validator_score(const char* value) {
  GOOGLE_DCHECK(value != nullptr);

  validator_score_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(value), GetArena());
  // @@protoc_insertion_point(field_set_char:vega.events.v1.ValidatorScoreEvent.validator_score)
}
inline void ValidatorScoreEvent::set_validator_score(const char* value,
    size_t size) {

  validator_score_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
  // @@protoc_insertion_point(field_set_pointer:vega.events.v1.ValidatorScoreEvent.validator_score)
}
inline std::string* ValidatorScoreEvent::_internal_mutable_validator_score() {

  return validator_score_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArena());
}
inline std::string* ValidatorScoreEvent::release_validator_score() {
  // @@protoc_insertion_point(field_release:vega.events.v1.ValidatorScoreEvent.validator_score)
  return validator_score_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline void ValidatorScoreEvent::set_allocated_validator_score(std::string* validator_score) {
  if (validator_score != nullptr) {

  } else {

  }
  validator_score_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), validator_score,
      GetArena());
  // @@protoc_insertion_point(field_set_allocated:vega.events.v1.ValidatorScoreEvent.validator_score)
}

// string normalised_score = 4 [json_name = "normalisedScore"];
inline void ValidatorScoreEvent::clear_normalised_score() {
  normalised_score_.ClearToEmpty();
}
inline const std::string& ValidatorScoreEvent::normalised_score() const {
  // @@protoc_insertion_point(field_get:vega.events.v1.ValidatorScoreEvent.normalised_score)
  return _internal_normalised_score();
}
inline void ValidatorScoreEvent::set_normalised_score(const std::string& value) {
  _internal_set_normalised_score(value);
  // @@protoc_insertion_point(field_set:vega.events.v1.ValidatorScoreEvent.normalised_score)
}
inline std::string* ValidatorScoreEvent::mutable_normalised_score() {
  // @@protoc_insertion_point(field_mutable:vega.events.v1.ValidatorScoreEvent.normalised_score)
  return _internal_mutable_normalised_score();
}
inline const std::string& ValidatorScoreEvent::_internal_normalised_score() const {
  return normalised_score_.Get();
}
inline void ValidatorScoreEvent::_internal_set_normalised_score(const std::string& value) {

  normalised_score_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArena());
}
inline void ValidatorScoreEvent::set_normalised_score(std::string&& value) {

  normalised_score_.Set(
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::move(value), GetArena());
  // @@protoc_insertion_point(field_set_rvalue:vega.events.v1.ValidatorScoreEvent.normalised_score)
}
inline void ValidatorScoreEvent::set_normalised_score(const char* value) {
  GOOGLE_DCHECK(value != nullptr);

  normalised_score_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(value), GetArena());
  // @@protoc_insertion_point(field_set_char:vega.events.v1.ValidatorScoreEvent.normalised_score)
}
inline void ValidatorScoreEvent::set_normalised_score(const char* value,
    size_t size) {
  ...
  normalised_score_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
  // @@protoc_insertion_point(field_set_pointer:vega.events.v1.ValidatorScoreEvent.normalised_score)
}
inline std::string* ValidatorScoreEvent::_internal_mutable_normalised_score() {

  return normalised_score_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArena());
}
inline std::string* ValidatorScoreEvent::release_normalised_score() {
  // @@protoc_insertion_point(field_release:vega.events.v1.ValidatorScoreEvent.normalised_score)
  return normalised_score_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline void ValidatorScoreEvent::set_allocated_normalised_score(std::string* normalised_score) {
  ...
  normalised_score_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), normalised_score,
      GetArena());
  // @@protoc_insertion_point(field_set_allocated:vega.events.v1.ValidatorScoreEvent.normalised_score)
}
...
// .vega.events.v1.ValidatorScoreEvent validator_score = 130 [json_name = "validatorScore"];
inline bool BusEvent::_internal_has_validator_score() const {
  return event_case() == kValidatorScore;
}
inline bool BusEvent::has_validator_score() const {
  return _internal_has_validator_score();
}
inline void BusEvent::set_has_validator_score() {
  _oneof_case_[0] = kValidatorScore;
}
inline void BusEvent::clear_validator_score() {
...
inline ::vega::events::v1::ValidatorScoreEvent* BusEvent::release_validator_score() {
  // @@protoc_insertion_point(field_release:vega.events.v1.BusEvent.validator_score)
  if (_internal_has_validator_score()) {
    clear_has_event();
      ::vega::events::v1::ValidatorScoreEvent* temp = event_.validator_score_;
    if (GetArena() != nullptr) {
      temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
    }
    event_.validator_score_ = nullptr;
    return temp;
  } else {
    return nullptr;
  }
}
inline const ::vega::events::v1::ValidatorScoreEvent& BusEvent::_internal_validator_score() const {
  return _internal_has_validator_score()
      ? *event_.validator_score_
      : reinterpret_cast< ::vega::events::v1::ValidatorScoreEvent&>(::vega::events::v1::_ValidatorScoreEvent_default_instance_);
}
inline const ::vega::events::v1::ValidatorScoreEvent& BusEvent::validator_score() const {
  // @@protoc_insertion_point(field_get:vega.events.v1.BusEvent.validator_score)
  return _internal_validator_score();
}
inline ::vega::events::v1::ValidatorScoreEvent* BusEvent::unsafe_arena_release_validator_score() {
  // @@protoc_insertion_point(field_unsafe_arena_release:vega.events.v1.BusEvent.validator_score)
  if (_internal_has_validator_score()) {
    clear_has_event();
    ::vega::events::v1::ValidatorScoreEvent* temp = event_.validator_score_;
    event_.validator_score_ = nullptr;
...
inline void BusEvent::unsafe_arena_set_allocated_validator_score(::vega::events::v1::ValidatorScoreEvent* validator_score) {
  clear_event();
  if (validator_score) {
    set_has_validator_score();
    event_.validator_score_ = validator_score;
  }
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:vega.events.v1.BusEvent.validator_score)
}
inline ::vega::events::v1::ValidatorScoreEvent* BusEvent::_internal_mutable_validator_score() {
  if (!_internal_has_validator_score()) {
    clear_event();
    set_has_validator_score();
    event_.validator_score_ = CreateMaybeMessage< ::vega::events::v1::ValidatorScoreEvent >(GetArena());
  }
  return event_.validator_score_;
}
inline ::vega::events::v1::ValidatorScoreEvent* BusEvent::mutable_validator_score() {
  // @@protoc_insertion_point(field_mutable:vega.events.v1.BusEvent.validator_score)
  return _internal_mutable_validator_score();
}
