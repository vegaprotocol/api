...
var file_markets_proto_rawDesc = []byte{
	...
	0x6e, 0x67, 0x46, 0x61, 0x63, 0x74, 0x6f, 0x72, 0x22, 0xda, 0x08, 0x0a, 0x06, 0x4d, 0x61, 0x72,
	...
	0x73, 0x22, 0xd8, 0x01, 0x0a, 0x05, 0x53, 0x74, 0x61, 0x74, 0x65, 0x12, 0x15, 0x0a, 0x11, 0x53,
	...
	0x54, 0x45, 0x5f, 0x53, 0x45, 0x54, 0x54, 0x4c, 0x45, 0x44, 0x10, 0x09, 0x22, 0xaf, 0x01, 0x0a,
	...
	0x52, 0x49, 0x4e, 0x47, 0x5f, 0x41, 0x55, 0x43, 0x54, 0x49, 0x4f, 0x4e, 0x10, 0x04, 0x42, 0x15,
	0x0a, 0x13, 0x74, 0x72, 0x61, 0x64, 0x69, 0x6e, 0x67, 0x5f, 0x6d, 0x6f, 0x64, 0x65, 0x5f, 0x63,
	0x6f, 0x6e, 0x66, 0x69, 0x67, 0x22, 0x72, 0x0a, 0x10, 0x4d, 0x61, 0x72, 0x6b, 0x65, 0x74, 0x54,
	...
	0x28, 0x03, 0x52, 0x05, 0x63, 0x6c, 0x6f, 0x73, 0x65, 0x42, 0x37, 0x0a, 0x14, 0x69, 0x6f, 0x2e,
...
var file_markets_proto_msgTypes = make([]protoimpl.MessageInfo, 22)
var file_markets_proto_goTypes = []interface{}{
	...
	(*v1.OracleSpec)(nil),             // 24: oracles.v1.OracleSpec
}
var file_markets_proto_depIdxs = []int32{
	24, // 0: vega.Future.oracle_spec:type_name -> oracles.v1.OracleSpec
	...
	15, // 14: vega.Market.tradable_instrument:type_name -> vega.TradableInstrument
	17, // 15: vega.Market.fees:type_name -> vega.Fees
	2,  // 16: vega.Market.opening_auction:type_name -> vega.AuctionDuration
	3,  // 17: vega.Market.continuous:type_name -> vega.ContinuousTrading
	4,  // 18: vega.Market.discrete:type_name -> vega.DiscreteTrading
	20, // 19: vega.Market.price_monitoring_settings:type_name -> vega.PriceMonitoringSettings
	21, // 20: vega.Market.target_stake_parameters:type_name -> vega.TargetStakeParameters
	1,  // 21: vega.Market.trading_mode:type_name -> vega.Market.TradingMode
	0,  // 22: vega.Market.state:type_name -> vega.Market.State
	23, // 23: vega.Market.market_timestamps:type_name -> vega.MarketTimestamps
