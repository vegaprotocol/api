...
func (x *VoteSubmission) GetValue() Vote_Value {
	if x != nil {
		return x.Value
	}
	return Vote_VALUE_UNSPECIFIED
...
var file_governance_proto_rawDesc = []byte{
	...
	0x0d, 0x0a, 0x09, 0x56, 0x41, 0x4c, 0x55, 0x45, 0x5f, 0x59, 0x45, 0x53, 0x10, 0x02, 0x22, 0x6a,
	...
	0x72, 0x6f, 0x70, 0x6f, 0x73, 0x61, 0x6c, 0x49, 0x64, 0x12, 0x2f, 0x0a, 0x05, 0x76, 0x61, 0x6c,
	0x75, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x10, 0x2e, 0x76, 0x65, 0x67, 0x61, 0x2e,
	0x56, 0x6f, 0x74, 0x65, 0x2e, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x42, 0x07, 0xe2, 0xdf, 0x1f, 0x03,
	0x88, 0x01, 0x01, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x2a, 0xe8, 0x0a, 0x0a, 0x0d, 0x50,
	...
	0x44, 0x5f, 0x50, 0x52, 0x4f, 0x44, 0x55, 0x43, 0x54, 0x10, 0x08, 0x12, 0x33, 0x0a, 0x2f, 0x50,
	...
	0x44, 0x55, 0x43, 0x54, 0x5f, 0x54, 0x49, 0x4d, 0x45, 0x53, 0x54, 0x41, 0x4d, 0x50, 0x10, 0x09,
	0x12, 0x2d, 0x0a, 0x29, 0x50, 0x52, 0x4f, 0x50, 0x4f, 0x53, 0x41, 0x4c, 0x5f, 0x45, 0x52, 0x52,
	0x4f, 0x52, 0x5f, 0x50, 0x52, 0x4f, 0x44, 0x55, 0x43, 0x54, 0x5f, 0x4d, 0x41, 0x54, 0x55, 0x52,
	0x49, 0x54, 0x59, 0x5f, 0x49, 0x53, 0x5f, 0x50, 0x41, 0x53, 0x53, 0x45, 0x44, 0x10, 0x0a, 0x12,
	...
	0x54, 0x45, 0x52, 0x10, 0x1e, 0x42, 0x37, 0x0a, 0x14, 0x69, 0x6f, 0x2e, 0x76, 0x65, 0x67, 0x61,
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x63, 0x6f, 0x6c, 0x2e, 0x76, 0x65, 0x67, 0x61, 0x5a, 0x1f, 0x63,
...
var file_governance_proto_msgTypes = make([]protoimpl.MessageInfo, 15)
var file_governance_proto_goTypes = []interface{}{
	...
	(*VoteSubmission)(nil),                // 15: vega.VoteSubmission
	nil,                                   // 16: vega.GovernanceData.YesPartyEntry
	nil,                                   // 17: vega.GovernanceData.NoPartyEntry
	(*v1.OracleSpecConfiguration)(nil),    // 18: oracles.v1.OracleSpecConfiguration
	(*OracleSpecToFutureBinding)(nil),     // 19: vega.OracleSpecToFutureBinding
	...
	(*SimpleModelParams)(nil),             // 22: vega.SimpleModelParams
	(*LogNormalRiskModel)(nil),            // 23: vega.LogNormalRiskModel
	(*ContinuousTrading)(nil),             // 24: vega.ContinuousTrading
	(*DiscreteTrading)(nil),               // 25: vega.DiscreteTrading
	(*LiquidityOrder)(nil),                // 26: vega.LiquidityOrder
	(*NetworkParameter)(nil),              // 27: vega.NetworkParameter
	(*AssetSource)(nil),                   // 28: vega.AssetSource
}
var file_governance_proto_depIdxs = []int32{
	18, // 0: vega.FutureProduct.oracle_spec:type_name -> oracles.v1.OracleSpecConfiguration
	19, // 1: vega.FutureProduct.oracle_spec_binding:type_name -> vega.OracleSpecToFutureBinding
	...
	20, // 4: vega.NewMarketConfiguration.price_monitoring_parameters:type_name -> vega.PriceMonitoringParameters
	21, // 5: vega.NewMarketConfiguration.liquidity_monitoring_parameters:type_name -> vega.LiquidityMonitoringParameters
	22, // 6: vega.NewMarketConfiguration.simple:type_name -> vega.SimpleModelParams
	23, // 7: vega.NewMarketConfiguration.log_normal:type_name -> vega.LogNormalRiskModel
	24, // 8: vega.NewMarketConfiguration.continuous:type_name -> vega.ContinuousTrading
	25, // 9: vega.NewMarketConfiguration.discrete:type_name -> vega.DiscreteTrading
	26, // 10: vega.NewMarketCommitment.sells:type_name -> vega.LiquidityOrder
	26, // 11: vega.NewMarketCommitment.buys:type_name -> vega.LiquidityOrder
	...
	27, // 14: vega.UpdateNetworkParameter.changes:type_name -> vega.NetworkParameter
	28, // 15: vega.NewAsset.changes:type_name -> vega.AssetSource
	...
	16, // 23: vega.GovernanceData.yes_party:type_name -> vega.GovernanceData.YesPartyEntry
	17, // 24: vega.GovernanceData.no_party:type_name -> vega.GovernanceData.NoPartyEntry
	...
	2,  // 29: vega.VoteSubmission.value:type_name -> vega.Vote.Value
	14, // 30: vega.GovernanceData.YesPartyEntry.value:type_name -> vega.Vote
	14, // 31: vega.GovernanceData.NoPartyEntry.value:type_name -> vega.Vote
...
func file_governance_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_governance_proto_msgTypes[12].Exporter = func(v interface{}, i int) interface{} {
