...
func (x *DelegateEntry) Reset() {
	*x = DelegateEntry{}
	if protoimpl.UnsafeEnabled {
		mi := &file_snapshot_v1_snapshot_proto_msgTypes[8]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*DelegateEntry) Descriptor() ([]byte, []int) {
	return file_snapshot_v1_snapshot_proto_rawDescGZIP(), []int{8}
}
...
func (x *Delegate) Reset() {
	*x = Delegate{}
	if protoimpl.UnsafeEnabled {
		mi := &file_snapshot_v1_snapshot_proto_msgTypes[9]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Delegate) Descriptor() ([]byte, []int) {
	return file_snapshot_v1_snapshot_proto_rawDescGZIP(), []int{9}
}
...
var file_snapshot_v1_snapshot_proto_rawDesc = []byte{
	...
	0x22, 0xb3, 0x01, 0x0a, 0x0a, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x70, 0x6f, 0x69, 0x6e, 0x74, 0x12,
	...
	0x6d, 0x65, 0x74, 0x65, 0x72, 0x73, 0x12, 0x1e, 0x0a, 0x0a, 0x64, 0x65, 0x6c, 0x65, 0x67, 0x61,
	0x74, 0x69, 0x6f, 0x6e, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x0a, 0x64, 0x65, 0x6c, 0x65,
	0x67, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0x55, 0x0a, 0x0a, 0x41, 0x73, 0x73, 0x65, 0x74, 0x45,
	...
	0x65, 0x6e, 0x64, 0x69, 0x6e, 0x67, 0x42, 0x4f, 0x0a, 0x20, 0x69, 0x6f, 0x2e, 0x76, 0x65, 0x67,
	0x61, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x63, 0x6f, 0x6c, 0x2e, 0x76, 0x65, 0x67, 0x61, 0x2e, 0x73,
	0x6e, 0x61, 0x70, 0x73, 0x68, 0x6f, 0x74, 0x2e, 0x76, 0x31, 0x5a, 0x2b, 0x63, 0x6f, 0x64, 0x65,
	0x2e, 0x76, 0x65, 0x67, 0x61, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x63, 0x6f, 0x6c, 0x2e, 0x69, 0x6f,
	0x2f, 0x76, 0x65, 0x67, 0x61, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x73, 0x6e, 0x61, 0x70,
...
var file_snapshot_v1_snapshot_proto_msgTypes = make([]protoimpl.MessageInfo, 10)
var file_snapshot_v1_snapshot_proto_goTypes = []interface{}{
	...
	(*proto1.AssetDetails)(nil),     // 10: vega.AssetDetails
	(*proto1.NetworkParameter)(nil), // 11: vega.NetworkParameter
	(*proto1.Proposal)(nil),         // 12: vega.Proposal
}
var file_snapshot_v1_snapshot_proto_depIdxs = []int32{
	10, // 0: vega.snapshot.v1.AssetEntry.asset_details:type_name -> vega.AssetDetails
	...
	11, // 3: vega.snapshot.v1.NetParams.params:type_name -> vega.NetworkParameter
	12, // 4: vega.snapshot.v1.Proposals.proposals:type_name -> vega.Proposal
...
func file_snapshot_v1_snapshot_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_snapshot_v1_snapshot_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
		...
		file_snapshot_v1_snapshot_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
