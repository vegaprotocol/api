...
_OBSERVEEVENTBATCH = _descriptor.Descriptor(
  name='ObserveEventBatch',
  full_name='api.ObserveEventBatch',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='batchSize', full_name='api.ObserveEventBatch.batchSize', index=0,
      number=1, type=3, cpp_type=2, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
DESCRIPTOR.message_types_by_name['ObserveEventBatch'] = _OBSERVEEVENTBATCH
...
ObserveEventBatch = _reflection.GeneratedProtocolMessageType('ObserveEventBatch', (_message.Message,), {
  'DESCRIPTOR' : _OBSERVEEVENTBATCH,
  '__module__' : 'proto.api.trading_pb2'
  # @@protoc_insertion_point(class_scope:api.ObserveEventBatch)
  })
_sym_db.RegisterMessage(ObserveEventBatch)
