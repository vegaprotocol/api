...
goog.exportSymbol('proto.vega.Future.OracleCase', null, global);
...
/**
 * optional EthereumEvent ethereum_event = 100;
...
proto.vega.Future.prototype.setEthereumEvent = function(value) {
  return jspb.Message.setOneofWrapperField(this, 100, proto.vega.Future.oneofGroups_[0], value);
};
...
proto.vega.Future.prototype.clearEthereumEvent = function() {
  return this.setEthereumEvent(undefined);
};
...
/**
 * @param {string} value
 * @return {!proto.vega.EthereumEvent} returns this
 */
...
proto.vega.Instrument.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    initialMarkPrice: jspb.Message.getFieldWithDefault(msg, 5, 0),
...
/**
 * optional uint64 initial_mark_price = 5;
 * @return {number}
 */
