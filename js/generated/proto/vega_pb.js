...
proto.vega.MarketData.prototype.clearPricemonitoringboundsList = function() {
  this.setPricemonitoringboundsList([]);
};
...
proto.vega.PriceMonitoringBounds.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    trigger: (f = msg.getTrigger()) && proto_markets_pb.PriceMonitoringTrigger.toObject(includeInstance, f)
  };
...
proto.vega.PriceMonitoringBounds.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 2:
      ...
      break;
    case 3:
      var value = new proto_markets_pb.PriceMonitoringTrigger;
      reader.readMessage(value,proto_markets_pb.PriceMonitoringTrigger.deserializeBinaryFromReader);
      msg.setTrigger(value);
      break;
    default:
      reader.skipField();
...
proto.vega.PriceMonitoringBounds.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      3,
      f,
      proto_markets_pb.PriceMonitoringTrigger.serializeBinaryToWriter
    );
  }
};
...
proto.vega.PriceMonitoringBounds.prototype.getTrigger = function() {
  return /** @type{?proto.vega.PriceMonitoringTrigger} */ (
    jspb.Message.getWrapperField(this, proto_markets_pb.PriceMonitoringTrigger, 3));
};
...
proto.vega.LiquidityOrderReference.prototype.clearLiquidityorder = function() {
  this.setLiquidityorder(undefined);
};
