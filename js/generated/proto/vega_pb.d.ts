...
export class MarketData extends jspb.Message {
  ...
  getMarketstate(): MarketStateMap[keyof MarketStateMap];
  setMarketstate(value: MarketStateMap[keyof MarketStateMap]): void;
...
export namespace MarketData {
  export type AsObject = {
    ...
    indicativeprice: number,
    indicativevolume: number,
    marketstate: MarketStateMap[keyof MarketStateMap],
...
export class PriceMonitoringBounds extends jspb.Message {
  ...
  hasTrigger(): boolean;
  clearTrigger(): void;
  getTrigger(): proto_markets_pb.PriceMonitoringTrigger | undefined;
  setTrigger(value?: proto_markets_pb.PriceMonitoringTrigger): void;
...
export namespace PriceMonitoringBounds {
  export type AsObject = {
    ...
    trigger?: proto_markets_pb.PriceMonitoringTrigger.AsObject,
  }
}
...
export interface MarketStateMap {
...
export const MarketState: MarketStateMap;
